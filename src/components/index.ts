...
export { ProjectTooltip, AnimatedTooltipPreview } from "./ui/ProjectTooltip";
...
export { BentoGridDemo } from "./sections/BentoGrid";
export { MyAusbildung } from "./sections/MyAusbildung";
